...
<t:html title="${i18n.pc_jktz_title }">
<head>
...
<t:page i18n="i18n.pc.pc">
	...
	<t:grid id="rigdGrid" idKeys="USERCENTER,KSSJENBLE,DDRQ,XIANH,LYXT,KAISSJB,JIESSJB"  load="false"
		caption="${i18n.pc_jktz_title }" src="/pc/adjustSelect.ajax" usePager="true"
		...
		<t:gridCol property="DINGDH" type="text" caption="${i18n.yaohlddh }"  width="150"  align="center"></t:gridCol>
