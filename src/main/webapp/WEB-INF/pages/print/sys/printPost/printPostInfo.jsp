...
<t:page i18n="i18n.print.i18n_print">
	<t:grid id="grid_ckx_printright" caption="${i18n.privew}"
		idKeys="userscode,scodes,storagescode,usercenter" src="/sys/queryPrintright.ajax"
		remove="NOT" edit="NOT" add="NOT" save="NOT"
		saveRowsSrcs="/sys/savesPrintright.ajax" editable="true" 
		...
		<t:fieldLayout id="setprview" prefix="spr">
			...
			<t:fieldText property="scodes" caption="${i18n.socdes}"
				maxLength="12" dataType="text" />
			<t:fieldText property="storagescode" caption="${i18n.storagescode}"
				maxLength="12" dataType="text" />
		</t:fieldLayout>
		...
		<t:gridCol property="storagescode" caption="${i18n.storagescode}"
			editor="fieldText"
			editorOptions="{closeEvent:func_set_storagescode,'notNull':true,'maxLength':'3','dataType':'text'}"></t:gridCol>
