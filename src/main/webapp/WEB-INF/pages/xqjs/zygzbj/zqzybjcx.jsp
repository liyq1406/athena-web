...
<t:html>
	...
	<t:fieldLayout prefix="layout" columns="4">
		<t:fieldSelect  property="usercenter" width="100" convert="queryUserCenterMap" caption="${i18n.usercenter}"></t:fieldSelect>
		<t:fieldSelect  property="jislx" width="100" src="/zygzbj/queryZyJslx.ajax" show="value" code="key" caption="${i18n.jslx}"></t:fieldSelect>
		<t:fieldText  property="cangkdm" width="100" caption="${i18n.ck}" maxLength="3"></t:fieldText>
		<t:fieldSelect  property="jihydm" width="100" convert="getJihz" caption="${i18n.jhyz}"></t:fieldSelect>
		<t:fieldSelect  property="zygy" width="100" convert="zygy" caption="${i18n.gyzy}"></t:fieldSelect>
		<t:fieldSelect  property="zhizlx" width="100" convert="queryZhizlx" caption="${i18n.zzlx}"></t:fieldSelect>
		<t:fieldText  property="lingjbh" width="100" caption="${i18n.ljh}" maxLength="10"></t:fieldText>
	...
	<t:gridCol property="jissj" caption="S0${i18n.riq}"></t:gridCol>
	<t:gridCol property="xuq0" renderer="xq0Renderer" colNum="2"  caption="S0"></t:gridCol>
	<t:gridCol property="yijf0" renderer="jf0Renderer" colNum="-1" caption=""></t:gridCol>
	<t:gridCol property="xuq1" renderer="xq1Renderer" colNum="2" caption="S1"></t:gridCol>
	<t:gridCol property="yijf1" renderer="jf1Renderer" colNum="-1" caption=""></t:gridCol>
	<t:gridCol property="xuq2" renderer="xq2Renderer" colNum="2" caption="S2"></t:gridCol>
	<t:gridCol property="yijf2" renderer="jf2Renderer" colNum="-1" caption=""></t:gridCol>
	<t:gridCol property="xuq3" renderer="xq3Renderer" colNum="2" caption="S3"></t:gridCol>
	<t:gridCol property="yijf3" renderer="jf3Renderer" colNum="-1" caption=""></t:gridCol>
	<t:gridCol property="xuq4" renderer="xq4Renderer" colNum="2" caption="S4"></t:gridCol>
	<t:gridCol property="yijf4" renderer="jf4Renderer" colNum="-1" caption=""></t:gridCol>
	<t:gridCol property="zongxq0" renderer="zxq0Renderer"  colNum="2" type="link" caption="P1"></t:gridCol>
	<t:gridCol property="zongyjf0" renderer="zjf0Renderer" colNum="-1" caption=""></t:gridCol>
	<t:gridCol property="zongxq1" renderer="zxq1Renderer" colNum="2" type="link" caption="P2"></t:gridCol>
	<t:gridCol property="zongyjf1" renderer="zjf1Renderer" colNum="-1" caption=""></t:gridCol>
	<t:gridCol property="zongxq2" renderer="zxq2Renderer" colNum="2" type="link" caption="P3"></t:gridCol>
	...
	*/
	function link_zongxq0(event){
		...
		var rowDoc = $(element).parents('tr:first')[0];
		var record = $('#grid_zygzbj').grid('getRecord',rowDoc);//获取当前行对应的记录
		window.open ('${ctx}/zygzbj/initMxZq.do?xuh=0&removeId=layout-north,layout-west,layout-south&id='+record.id+'&anqkc='+record.anqkc+'&cangkdm='+record.cangkdm,
				'${i18n.bjlb}','height=550,width=1100,top=100,left=100,toolbar=no,menubar=no,scrollbars=no, resizable=no,location=no, status=no');
		
		/**
		
		$.sdcui.pageUtils.goPage({
			url:'/zygzbj/initMxZq.do?xuh=0',//url
			record:record,//
			mode:'form',
			beforeSubmit:function(){
				return true;
	...
	*/
	function link_zongxq1(event){
		...
		var rowDoc = $(element).parents('tr:first')[0];
		var record = $('#grid_zygzbj').grid('getRecord',rowDoc);//获取当前行对应的记录
		window.open ('${ctx}/zygzbj/initMxZq.do?xuh=1&removeId=layout-north,layout-west,layout-south&id='+record.id+'&anqkc='+record.anqkc+'&cangkdm='+record.cangkdm,
				'${i18n.bjlb}','height=550,width=1100,top=100,left=100,toolbar=no,menubar=no,scrollbars=no, resizable=no,location=no, status=no');
		
		/**
		
		$.sdcui.pageUtils.goPage({
			url:'/zygzbj/initMxZq.do?xuh=1',//url
			record:record,//
			mode:'form',
			beforeSubmit:function(){
				return true;
	...
	*/
	function link_zongxq2(event){
		...
		var rowDoc = $(element).parents('tr:first')[0];
		var record = $('#grid_zygzbj').grid('getRecord',rowDoc);//获取当前行对应的记录
		window.open ('${ctx}/zygzbj/initMxZq.do?xuh=2&removeId=layout-north,layout-west,layout-south&id='+record.id+'&anqkc='+record.anqkc+'&cangkdm='+record.cangkdm,
				'${i18n.bjlb}','height=550,width=1100,top=100,left=100,toolbar=no,menubar=no,scrollbars=no, resizable=no,location=no, status=no');
		/**
		 
		$.sdcui.pageUtils.goPage({
			url:'/zygzbj/initMxZq.do?xuh=2',//url
			record:record,//
			mode:'form',
			beforeSubmit:function(){
				return true;
	...
	*/
	function link_zongxq3(event){
		...
		var rowDoc = $(element).parents('tr:first')[0];
		var record = $('#grid_zygzbj').grid('getRecord',rowDoc);//获取当前行对应的记录
		window.open ('${ctx}/zygzbj/initMxZq.do?xuh=3&removeId=layout-north,layout-west,layout-south&id='+record.id+'&anqkc='+record.anqkc+'&cangkdm='+record.cangkdm,
				'${i18n.bjlb}','height=550,width=1100,top=100,left=100,toolbar=no,menubar=no,scrollbars=no, resizable=no,location=no, status=no');
		/**
		
		$.sdcui.pageUtils.goPage({
			url:'/zygzbj/initMxZq.do?xuh=3',//url
			record:record,//
			mode:'form',
			beforeSubmit:function(){
				return true;
	...
	*/
	function link_zongxq4(event){
		...
		var rowDoc = $(element).parents('tr:first')[0];
		var record = $('#grid_zygzbj').grid('getRecord',rowDoc);//获取当前行对应的记录
		window.open ('${ctx}/zygzbj/initMxZq.do?xuh=4&removeId=layout-north,layout-west,layout-south&id='+record.id+'&anqkc='+record.anqkc+'&cangkdm='+record.cangkdm,
				'${i18n.bjlb}','height=550,width=1100,top=100,left=100,toolbar=no,menubar=no,scrollbars=no, resizable=no,location=no, status=no');
		/**
		
		$.sdcui.pageUtils.goPage({
			url:'/zygzbj/initMxZq.do?xuh=4',//url
			record:record,//
			mode:'form',
			beforeSubmit:function(){
				return true;
	...
	*/
	function link_zongxq5(event){
		...
		var rowDoc = $(element).parents('tr:first')[0];
		var record = $('#grid_zygzbj').grid('getRecord',rowDoc);//获取当前行对应的记录
		window.open ('${ctx}/zygzbj/initMxZq.do?xuh=5&removeId=layout-north,layout-west,layout-south&id='+record.id+'&anqkc='+record.anqkc+'&cangkdm='+record.cangkdm,
				'${i18n.bjlb}','height=550,width=1100,top=100,left=100,toolbar=no,menubar=no,scrollbars=no, resizable=no,location=no, status=no');
		/**
		
		$.sdcui.pageUtils.goPage({
			url:'/zygzbj/initMxZq.do?xuh=5',//url
			record:record,//
			mode:'form',
			beforeSubmit:function(){
				return true;
