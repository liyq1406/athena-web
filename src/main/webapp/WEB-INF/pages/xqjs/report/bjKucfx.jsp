...
<t:html>
	...
	<t:page i18n="i18n.xqjs.report.il18n_kucfx" >
		<t:grid id="grid_maoxqo" load="true" showNum="true" submit="NOT" reset="NOT" scrollHeight="100" idKeys="xuqbc"
		add="NOT" edit="NOT" remove="NOT" src="/ilorder/queryMaoxqo.ajax">
			<t:fieldLayout prefix="gridLayout" columns="3">
					<t:fieldSelect width="150" show="gonghms" code="xuqly" convert="xuqly" caption="${i18n.xuqly}" property="xuqly" defaultValue="DKS" readonly="true"></t:fieldSelect>
			</t:fieldLayout>
	...
	<t:grid id="grid_lingj" caption="KD件15天库存不足报警信息"  load="false" showNum="true"   back="NOT"
		 src="/report/queryBjKuc.ajax"  remove="NOT" add="NOT" edit="NOT"  usePager="true"   >
		<t:fieldLayout prefix="record">
			...
			<t:fieldHidden property="qxuqbc"> </t:fieldHidden>
		</t:fieldLayout>
		...
		<t:gridCol property="lingjbh" caption="${i18n.lingjbh}" width="130"></t:gridCol>
		<t:gridCol property="shiycj" caption="使用车间"></t:gridCol>
		<t:gridCol property="cangkdm" caption="仓库代码" width="80"></t:gridCol>
		<t:gridCol property="kucsl" caption="仓库库存数量" width="150"></t:gridCol>
		<t:gridCol property="zhongxqsl" caption="107数量" width="150"></t:gridCol>
		<t:gridCol property="ysgsl" caption="YSG数量" width="150"></t:gridCol>
		<t:gridCol property="cmj" caption="CMJ" width="150"></t:gridCol>
