...
<t:html>
	...
	<t:grid id="grid_lingj" caption="KD件库存信息"  load="false" showNum="true"   back="NOT"
		 src="/report/queryKdKuc.ajax"  remove="NOT" add="NOT" edit="NOT"  usePager="true"   >
