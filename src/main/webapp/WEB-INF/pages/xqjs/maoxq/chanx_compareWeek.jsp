...
<t:html title="${i18n.mxqcxbj}" >
	...
	<t:form id="form_maoxqWeek" submit="NOT" reset="NOT">
	       ...
	       <t:grid id="grid_compareChanxWeek"  caption="${i18n.zmxq}"     
			...
			<t:gridCol  property="s11Week2"   type="text" caption="S11"  ></t:gridCol>
	...
	/*	function func_button_back() {
			...
			function func_grid_expxls(){
			    var red = $("#grid_compareChanxWeek").grid("getRecords");
		        if(red.length==0){
