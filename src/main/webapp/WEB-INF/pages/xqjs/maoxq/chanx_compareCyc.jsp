...
<t:html title="${i18n.mxqcxbj}" >
	...
	<t:form id="form_maoxqCyc" submit="NOT" reset="NOT">
	       ...
	       <t:grid id="grid_compareChanxCyc"  caption="${i18n.zqmxq}"     
			...
			<!-- XSS V4_008 -->
			<t:gridCol  property="gongysbh"     type="text" caption="${i18n.gongysdm}"   ></t:gridCol>
			<t:gridCol  property="gongsmc"     type="text" caption="${i18n.gongysmc}"   ></t:gridCol>
			<t:gridCol  property="gcbh"     type="text" caption="${i18n.chengysdm}"   ></t:gridCol>
			<t:gridCol  property="chengysmc"     type="text" caption="${i18n.chengysmc}"   ></t:gridCol>
	...
	<script type="text/javascript">
       ...
       //返回
		...
		function func_grid_expxls(){
		        var red = $("#grid_compareChanxCyc").grid("getRecords");
		        if(red.length==0){
