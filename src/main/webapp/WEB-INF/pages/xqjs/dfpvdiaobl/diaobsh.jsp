...
<t:html title="${i18n.diaobl_sh}" >
	...
	src="/dfpvdiaobl/searchDiaobSq.ajax" add="NOT" edit="NOT" remove="NOT" back="NOT" idKeys="diaobsqdh">
	...
	*/
	function link_diaobsqdh(event){
		...
		winOpen = window.open ('${ctx}/dfpvdiaobl/initDiaobSqMx.do?&usercenter='+usercenter+'&diaobsqdh='+diaobsqdh+'&diaobsqsj='+diaobsqsj+'&zhuangt='+zhuangt,
		'${i18n.diaobl_sh}',
	...
	function func_button_diaobsm()
	{
		...
		{
			 $.sdcui.ajaxUtil.ajax({
                  url:"${ctx}/dfpvdiaobl/dodiaobsm.ajax",
	...
	*/
	...
	function chaydy(){
		...
		params.push("dbsq.diaobsqsj="+diaobsqsj);
					...
					$.sdcui.ajaxUtil.ajax({
						url : "${ctx}/dfpvdiaobl/cyprint.ajax",//请求url
						data : "usercenter=" + usercenter + "&diaobsqdh="
