			...
			<tr>
				...
				<t:grid id="grid_diaobsqmx" caption="${i18n.diaobsqmx}"
						idKeys="usercenter,diaobsqdh,lingjbh,lux,edit_time,editor"
						 ...
						 src="/diaobl/searchZzDiaobSqMx.ajax" showNum="true"
                    ...
                    <t:form id="form_dbd" submit="NOT" reset="NOT">
								<t:grid idKeys="lingjbh,usercenter,diaobdh" id="grid_diaobdmx"
									...
									src="/diaobl/searchZzDiaobdMx.ajax" add="NOT" edit="NOT"
...
<script type="text/javascript">
	...
	*/
	...
	function ljzz() {
		...
		$.sdcui.ajaxUtil.ajax({
			url : "${ctx}/diaobl/ljzz.ajax",//请求url
			data : params.join('&'),
	...
	function ljckzz() {
		...
		$.sdcui.ajaxUtil.ajax({
			url : "${ctx}/diaobl/ljckzz.ajax",//请求url
			data : dataStr,
			success : function(result) {
				alert(result.result);
				$('#grid_diaobdmx').grid('reload');
