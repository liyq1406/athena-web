...
<t:html title="${i18n.diaoblqr }" >
	...
	<t:page  i18n="i18n.xqjs.diaobl.diaoblquery" >
	   <t:form id="diaobl_query"  reset="NOT" submit="NOT" >
		<t:grid id="grid_diaobsq" idKeys="usercenter,diaobsqdh,editor,edit_time,zhuangt,banc" caption="${i18n.diaobdlb }"  showNum="true"    showCheckbox="true"
			src="/diaobl/select.ajax"  usePager="true"  add="NOT"  remove="NOT"  edit="NOT"  load="false" back="NOT" scrollHeight="310" >
              	
               
				<t:fieldLayout  id="sq_select" prefix="sq" columns="4">
				              <t:fieldSelect property="usercenter" caption="${i18n.usercenter}" convert="queryUserCenterMap"  width="135"></t:fieldSelect>
				...
				<t:gridCol   property="diaobsqdh"  type="link" caption="${i18n.diaobsqdh}"  orderBy="desc" sortProperty="diaobsqdh"></t:gridCol>
        ...
        <form id="linkGo" action="${ctx}/diaobl/initEdit.do" method="POST">
	...
	*/
	function link_diaobsqdh(event){
		...
		winOpen = window.open ('${ctx}/diaobl/initEdit.do?removeId=layout-north,layout-west,layout-south&usercenter='+usercenter+'&diaobsqdh='+diaobsqdh+'&diaobsqsj='+diaobsqsj+'&banc='+banc+'&zhuangt='+zhuangt,
