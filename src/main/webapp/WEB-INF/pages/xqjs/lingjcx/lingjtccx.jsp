	...
	<t:page  i18n="i18n.xqjs.lingjcx.lingjtccx">
		<t:grid id="grid_lingjtccx" 
			...
			<t:fieldLayout columns="4" prefix="select">
				...
				<t:fieldText property="tcNo" width="100" caption="${i18n.tcNo}"></t:fieldText>
			</t:fieldLayout>
			<t:gridCol property="tcNo" width="100" caption="${i18n.tcNo}" type="link"/>
			<t:gridCol property="qiysj" width="100" caption="关箱时间"/>
			...
			<t:gridCol property="lingjzl" caption="${i18n.lingjzl}"  convert="queryUserCenterMap"/>
		</t:grid>
	</t:page>
</t:html>