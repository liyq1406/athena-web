...
<t:html>
	...
	<t:page  i18n="i18n.xqjs.lingjcx.lingjtcyaohlcx">
		<t:grid id="grid_lingjtcyaohlcx" 
			...
			add="NOT"
			edit="NOT"
			remove="NOT"  back="NOT"  showNum="true">
			<t:fieldLayout columns="4" prefix="select">
				...
				<t:fieldText property="yaohlh" width="150" caption="${i18n.yaohlh}" maxLength="12"></t:fieldText>
				<t:fieldCalendar property="jiaofj" width="150" caption="${i18n.jiaofj}" format="yyyy-MM-dd" ></t:fieldCalendar>
			</t:fieldLayout>
