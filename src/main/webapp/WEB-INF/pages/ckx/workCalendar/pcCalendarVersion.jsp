...
<t:html>
	...
	<t:page i18n="i18n.ckx.workCalendar.i18n_workCalendar">
		<t:grid id="grid_CkxCalendarVersion" 
			...
			caption="${i18n.rilbc}" 
			src="/PCcalendar/queryCkxCalendarVersion.ajax"
			editAlias="editList"
			saveRowsSrcs="/PCcalendar/saveCkxCalendarVersion.ajax"
			load="false"
scrollHeight="290" pageSize="15"
			...
			<t:fieldLayout prefix="record0">
				...
				<t:fieldSelect property="banc" caption="${i18n.banch}" src="getVersionNo.ajax" show="banc" code="banc" parents="usercenter"/>
...
<%-- 			<t:button name="editCalendarVersionNianzx" caption="${i18n.update}${i18n.nianzx}" icon="editRecord" active="1"></t:button> --%>
		...
		<!-- 添加版次form -->
		<t:form dialog="true" reset="NOT" id="form_addCkxCalendarVersion" caption="${i18n.rilbc}" action="/PCcalendar/addVersion.ajax" >
		...
		<!-- 复制版次form -->
		<t:form dialog="true" reset="NOT" id="form_copyCkxCalendarVersion" caption="${i18n.rilbc}" action="/PCcalendar/copyVersion.ajax">
		...
		<!-- 添加日历form -->
		<t:form dialog="true" reset="NOT" id="form_addCkxCalendarDay" caption="${i18n.ril}" action="/PCcalendar/addDay.ajax">
		...
		<!-- 删除版次form -->
		<t:form dialog="true" reset="NOT" id="form_delCkxCalendarVersion" caption="${i18n.rilbc}" action="/PCcalendar/delVersion.ajax">
			<t:fieldLayout prefix="record4">
				<t:fieldText property="versionCode" readonly="true" caption="${i18n.banch}" notNull="true" dataType="text" maxLength="8" minLength="8"></t:fieldText>
			</t:fieldLayout>
		</t:form>
			<!--修改版次年周序form -->
		<t:form dialog="true" reset="NOT" id="form_editCalendarVersionNianzx" caption="${i18n.nianzx}" action="/PCcalendar/editCalendarVersionNianzx.ajax">
