...
<t:page i18n="i18n.ckx.xuqjs.i18n_quhys">
	<t:grid id="grid_quhyuns" caption="" 
	idKeys="usercenter,jinjjid,gongysdm" 
	editable="true"  
	back="NOT" 
	scrollHeight="290" 
	pageSize="15"
	src="/xuqjs/queryJinjjQuhYuns.ajax" 
	load="false" 
	saveRowsSrcs="/xuqjs/savesJinjjQuhYuns.ajax"
	...
	showEditorRemoveName="editorRemove" >
		...
		<t:gridCol   property="shengxsj" caption="${i18n.shengxsj}" editor="fieldCalendar" width="150" editorOptions="{'format':'yyyy-MM-dd','notNull':true,closeEvent:func_set_shengxsj}"></t:gridCol>
		<t:gridCol   property="shixsj" caption="${i18n.shixsj}" editor="fieldCalendar" width="150" editorOptions="{'format':'yyyy-MM-dd','notNull':true,closeEvent:func_set_shixsj}"></t:gridCol>
		<t:gridCol  property="tangcdj" caption="趟次单价" editor="fieldText" width="100" editorOptions="{'expression':'^[1-9][0-9]{0,9}(?:\.[0-9]{1,3})?$|0\.[0-9]{1,3}$','expressionMessage':'${i18n.zuixqdl_ex_mes }','notNull':true}"></t:gridCol>
		...
		<t:gridCol   hidden="true"  property="jinjjid" caption="" width="0" />
			
				
	</t:grid>
		<t:file action="/xuqjs/importAth_uploadquhyunsJinjj.do" size="100">
		<t:fileparam sheet="quhyunsMob" keys="usercenter,gongysdm,chengysdm" table="{dbSchemal3}CKX_QUHYSFY_jinjj" datasourceId="1" />
	</t:file>		
</t:page>
...
function func_set_shengxsj(){
	...
	function func_button_mobxz(){
		...
		$.sdcui.pageUtils.goPage({
			url : '../xuqjs/downloadquhyunsJinjjMob.do',
			mode : 'form',
