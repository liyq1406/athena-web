...
<t:page i18n="i18n.ckx.transTime.i18n_cschushlk">
	<t:grid id="grid_cschushlk" caption="${i18n.cschushlk}" idKeys="usercenter,chanx" src="/transTime/queryCkxCsChushlk.ajax" 
		add="NOT" edit="NOT" back="NOT" scrollHeight="335" pageSize="15"
		editable="true"  saveRowsSrcs="/transTime/lakongCkxCsChushlk.ajax" 
        ...
        <t:fieldLayout id="fl_kuwdj" prefix="cschushlk" columns="4">
			...
			<t:fieldText property="huoch" caption="${i18n.xiaohcbh}" dataType="text" maxLength="5" width="110"/>
			</t:fieldLayout>
