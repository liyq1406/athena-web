...
<%request.setAttribute("pageId","31403");%>
...
<t:html i18n="i18n.ck">
	<head>
		...
		<script type="text/javascript">
			...
			<%	} %>
			if ("314" ==flag){
				$(document).attr("title", '${i18n.title_31403B}');
			} else {
				$(document).attr("title", '${i18n.title_31403A}');
			}
			$(function(){
               ...
               /* var searchParam = [];
				...
				$('#grid_user_${pageId}').grid({
					...
					cols:[
						...
						{property:'shangxxh',caption:'${i18n.kehbz}',width:50},
						{property:'xiehd',caption:'${i18n.xiehd}',width:50},
						{property:'ucrl',caption:'${i18n.ucrl}',width:50},
			 	...
			 	$('#form_user_${pageId}').form({
			 		...
			 		fields:[
	                    ...
	                    {fieldType:'fieldLabel',property:'peizdh',value:parameter.peizdh},
	                    {fieldType:'fieldLabel',property:'cheph',value:parameter.cheph},
			 	...
			 	<table class="ui-grid" cellspacing="1" width="100%">
					<tbody>
						<tr>
							...
							<td>${i18n.peizdh}:</td>
							<td><div class="ui-field" id="peizdh"></div></td>
						</tr>
                        <tr>
							<td>${i18n.cheph}:</td>
							<td><div class="ui-field" id="cheph"></div></td>
							<td>${i18n.keh}:</td>
