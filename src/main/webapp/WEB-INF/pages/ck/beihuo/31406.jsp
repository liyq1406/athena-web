...
<%request.setAttribute("pageId","31406");%>
...
<t:html i18n="i18n.ck">
	<head>
		...
		<script type="text/javascript">
			...
			<%	} %>
			if ("314" ==flag){
				$(document).attr("title", '${i18n.title_31406B}');
			} else {
				$(document).attr("title", '${i18n.title_31406A}');
			}
			$(function(){
				...
				$('#grid_user_${pageId}').grid({
					...
					cols:[
						...
						{property:'tongblshqj',caption:'${i18n.qizlsh}',width:50},
						{property:'peislb',caption:'${i18n.peislx}',width:50},
						...
						{property:'xiaosxsj',caption:'${i18n.zuizsxsj}',width:50},
