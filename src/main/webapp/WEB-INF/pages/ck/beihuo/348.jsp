...
<%request.setAttribute("pageId","348");%>
<%@ taglib prefix="t" uri="http://www.isoftstone.com/sdc/ui"%>
<t:html i18n="i18n.ck">
	<head>
		<title>${i18n.title_348}</title>
		...
		<script type="text/javascript">
			$(function(){
				$('#grid_user_${pageId}').grid({
					...
					//records:{'result':{'total':2,'rows':[{'yicsbdh':'0000000','lingjh':123,'shenbrxm':234,'gongys':348,'lingjmc':12348,'shenbsl':901,'lingjdw':322,'yuanbzdj':'N'},{'yicsbdh':'0000001','lingjh':123,'shenbrxm':234,'gongys':348,'lingjmc':12348,'shenbsl':901,'lingjdw':322,'yuanbzdj':'N'}]}},
					buttons:[
                        //F1查询
			 	...
			 	$('#form_user_${pageId}').form({
			 		...
			 		fields:[
						{fieldType:'fieldText',property:'keh',dataType:'keh',notNull:true,caption:'${i18n.keh}'},
						{fieldType:'fieldText',property:'gongysdm',dataType:'letter_numeric',limitedLength:'10',caption:'${i18n.gongysdm}'},
						{fieldType:'fieldSelect',property:'xiehzt',caption:'${i18n.xiehzt}',notNull:true,src:'<%=request.getContextPath()%>/common/xiehzt.do'+st_Params+"&cangkbh="+st_Cangkbh+'&biaos=1'},
