...
<%request.setAttribute("pageId","31401");%>
...
<t:html i18n="i18n.ck">
	<head>
		...
		<script type="text/javascript">
			...
			<%	} %>
			if ("314" ==flag){
				$(document).attr("title", '${i18n.title_31401B}');
			} else {
				$(document).attr("title", '${i18n.title_31401A}');
			}
			   ...
			   /* var searchParam = [];
				...
				$('#grid_user_${pageId}').grid({
					...
					cols:[
						...
						{property:'shangxxh',caption:'${i18n.shangxbz}',width:50},
						{property:'xiehd',caption:'${i18n.xiehd}',width:50},
			 	...
			 	$('#form_user_${pageId}').form({
			 		...
			 		fields:[
						...
						{fieldType:'fieldLabel',property:'yaohlsl',value:$.sdcui.resource.i18n[parameter.yaohlslxx]},
						...
						{fieldType:'fieldLabel',property:'gonghmsxx',value:$.sdcui.resource.i18n[parameter.gonghmsxx]},
