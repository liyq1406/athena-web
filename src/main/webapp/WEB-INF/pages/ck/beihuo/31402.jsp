...
<%request.setAttribute("pageId","31402");%>
...
<t:html i18n="i18n.ck">
	<head>
		...
		<script type="text/javascript">
			...
			<%	} %>
			if ("314" ==flag){
				$(document).attr("title", '${i18n.title_31402B}');
			} else {
				$(document).attr("title", '${i18n.title_31402A}');
			}
			...
			$(function(){
              ...
              /*  var searchParam = [];
				...
				$('#grid_user_${pageId}').grid({
					...
					cols:[
						{property:'yaohlh',caption:'${i18n.yaohlh}',width:'30'},
						{property:'lingjbh',caption:'${i18n.lingjh}',width:'40'},
						{property:'xiaohd',caption:'${i18n.xiaohd}',width:'30'},
						{property:'kuwbh',caption:'${i18n.kuw}',width:'30'},
						...
						{property:'shangxfs',caption:'${i18n.fangs}',width:'30'},
						{property:'usucxh',caption:'${i18n.usucxh}',width:'50'},
						{property:'shangxxh',caption:'${i18n.shangxbz}',width:'40'},
						{property:'ucrl',caption:'${i18n.ucrl}',width:'30'},
						{property:'chex',caption:'${i18n.chex}',width:'40'},
			 	...
			 	$('#form_user_${pageId}').form({
			 		...
			 		fields:[
						...
						{fieldType:'fieldLabel',property:'chejh',value:parameter.chejh},
						{fieldType:'fieldLabel',property:'chanx',value:parameter.chanx},
						{fieldType:'fieldLabel',property:'gongzr',value:parameter.gongzr},
						{fieldType:'fieldLabel',property:'huoch',value:parameter.huoch},
						{fieldType:'fieldLabel',property:'tangc',value:parameter.tangc},
						{fieldType:'fieldLabel',property:'bhsj',value:parameter.bhsj},
			 	...
			 	<table class="ui-grid" cellspacing="1" width="100%">
					<tbody>
						<tr>
							...
							<td>${i18n.chej}:</td>
							<td><div class="ui-field" id="chejh"></div></td>
						</tr>
                        <tr>
							<td>${i18n.xianh}:</td>
							<td><div class="ui-field" id="chanx"></div></td>
							<td>${i18n.gongzr}:</td>
							<td><div class="ui-field" id="gongzr"></div></td>
							<td>${i18n.huoch}:</td>
