...
<%request.setAttribute("pageId","334");%>
<%@ taglib prefix="t" uri="http://www.isoftstone.com/sdc/ui"%>
<t:html i18n="i18n.ck">
	<head>
		<title>${i18n.title_334}</title>
		<jsp:include page="../../common/js.jsp" />
		<script type="text/javascript">
			$(function(){
				$('#grid_user_${pageId}').grid({
					keyFields:['ush','shifdj'],
					id:'grid_user_${pageId}',
					//查询交易
					src:'<%=request.getContextPath()%>/kunei/33401.do',
					//明细行修改交易
					editSubmitSrc:'<%=request.getContextPath()%>/kunei/33402.do',
					cols:[
						...
						{property:'usxh',caption:'${i18n.rongqxh}'},
				  		...
				  		{property:'shifdj',caption:'${i18n.shifdj}',editor:'fieldText',
			 	...
			 	$('#form_user_${pageId}').form({
			 		...
			 		onreload:true,
			 		fields:[
			 		        {fieldType:'fieldText',biaos:'enter',property:'elh',dataType:'elh'},
	         ...
	         function doSearch(){
				...
				//加载数据
                var url = "<%=request.getContextPath()%>/kunei/33401.do";
                    g_isSub = 0;
