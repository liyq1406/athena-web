...
<%request.setAttribute("pageId","64201");%>
<%
...
int cishu= Integer.parseInt(map.get("xuh").toString());//次数

//int cishu=cs_temp+cs;//当前次数 0011242
...
<tr align="center">
<td align="right"><font size="3"><strong>返还单号</strong></font>:</td>
<td align="left" ><%=map.get("fanhdh") %></td>
<td align="right"><font size="3"><strong>流水号</strong></font>:</td>
<td align="left" ><%=cishu%></td>
<td align="right"><font size="3"><strong>记账区</strong></font>:</td>
...
<tr align="center">
 ...
 <td><font size="3" ><strong>容器包号</strong></font></td>
 <td><font size="3" ><strong>数量</strong></font></td>
 <td colspan="3"><font size="3" ><strong>摘要</strong></font></td>
 </tr> 
<%for(int a=(num-1)*7;(a < num*7 && a <list2.size());a++){ %>
 <tr align="center">
 	<% if(list2.get(a).getRongqbh()==null){break;}%> 
	
   	<%if(list2.get(a).getRongqbh()!=null){%>
		 <td id="xuh"  ><%=a+1 %></td>
		 
		<td id="gongysdm" height="1px"><%=list2.get(a).getGongysdm()  %> </td>
		 		 
		<%if( list2.get(a).getGongysmc()!=null ){%>
	  	<td id="gongysmc" height="1px"><%=list2.get(a).getGongysmc()%></td>
		<%}else{ %>
		<td id="gongysmc" height="1px"></td>
		<% }%>	
		 
		 <td id="rongqbh"  ><%=list2.get(a).getRongqbh() %> </td>
		 <td id="rongqsl"  ><%=list2.get(a).getRongqsl() %></td>
		 <td id="zhaiy" colspan="3" >返还</td>
	<%}%>
 </tr>  
 <%} %>
 <tr align="center">
 ...
 <%for(int b=(num-1)*7;(b < num*7 && b<list3.size());b++){ %>
 <tr align="center"> 
 	<% if(list3.get(b).getRongqxh()==null){break;}%>
	
  	<%if(list3.get(b).getRongqxh()!=null){%>
 		 <td id="xuh" height="1px"><%=b+1 %></td>
 		 
 		<td id="gongysdm"><%=list3.get(b).getGongysdm() %></td>	 
		  
		<%if(list3.get(b).getGongysmc()!=null){%>
	  	<td id="gongysmc" height="1px"><%=list3.get(b).getGongysmc()%></td>
		<%}else{ %>
		<td id="gongysmc" height="1px"></td>
		<% }%>	
 		 
  		 <td id="rongqxh"><%=list3.get(b).getRongqxh()%></td>
  		 <td id="rongqsl" height="1px"><%=list3.get(b).getRongqsl()%></td>
 	     <td id="zhaiy" colspan="3">返还</td>
	<%}%>
 </tr>  
 <%} %> 
