	...
	$('#form_user_${pageId}').form({
		onreload:true,
 		fields:[
				...
				{fieldType:'fieldSelect',biaos:'enter',property:'gongysdm',maxLength:'10',caption:'${i18n.gongysdm}',onselect:'flagchange()',notNull:true},
				{fieldType:'fieldLabel',property:'gongysmc',maxLength:'35',caption:'${i18n.gongysmc}',notNull:true},
				{fieldType:'fieldSelect',biaos:'enter',property:'shengbd',onselect:'shenbd()',dataType:'text',maxLength:'9',caption:'${i18n.shengbd}',notNull:true},
				...
				//{fieldType:'fieldSelect',property:'yuany',caption:'${i18n.yuany}',includeNull:true,notNull:true,src:'<%=request.getContextPath()%>/common/getYuanYin.do'},								
...
function shenbd(){
	if(!$('#lingjbh').fieldText('validateNotNull')){
		...
		//0010509
		if(!$('#yuanyin').fieldSelect('validateNotNull')){
 			return;
 		}
