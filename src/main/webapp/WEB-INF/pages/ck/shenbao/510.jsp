...
<%request.setAttribute("pageId","510");%>
<t:html i18n="i18n.ck">
	<head>
		<title>${i18n.title_510}</title>
		...
		<script type="text/javascript">
			$(function(){
			 	$('#form_user_${pageId}').form({
			 	    ...
			 	    onemoredemand:true,
			 		fields:[
			 		        {fieldType:'fieldSelect',property:'wulid',includeNull:true,src:'<%=request.getContextPath()%>/common/wulidian.do?leix=E',caption:'${i18n.wuld}'},
 			    ...
 			    $('#grid_user_${pageId}').grid({
					...
					src:'<%=request.getContextPath()%>/shenbao/51001.do',
					cols:[  
					        {property:'wulid',caption:'${i18n.wuld}'},
							{property:'edit_time',caption:'${i18n.shengbrq}'},
							{property:'jizxh',caption:'${i18n.jizxh}'},
							{property:'kongxsbr',caption:'${i18n.shengbr}'}
				        ],
				 buttons:[
