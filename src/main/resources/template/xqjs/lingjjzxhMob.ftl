...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
 ...
 <Styles>
  <Style ss:ID="Default" ss:Name="Normal">
   ...
   <Borders/>
   <Font ss:FontName="宋体" x:Family="Swiss" x:CharSet="134" ss:Size="9" ss:Color="#000000"/>
   <Interior/>
   <NumberFormat/>
   <Protection/>
  </Style>
 ...
 <Worksheet ss:Name="lingjjzxh">
  <Table ss:ExpandedColumnCount="26" ss:ExpandedRowCount="3" x:FullColumns="1"
   x:FullRows="1">
   <Column ss:StyleID="s62" ss:Width="62.25"/>
   <Column ss:StyleID="s62" ss:AutoFitWidth="0" ss:Width="82.5" ss:Span="2"/>
   <Column ss:Index="5" ss:StyleID="s62" ss:AutoFitWidth="0" ss:Width="69.75"/>
   ...
   <Column ss:Index="14" ss:StyleID="s62" ss:Width="80.25"/>
   <Column ss:StyleID="s62" ss:Width="58.5"/>
   <Column ss:StyleID="s62" ss:Width="91.5"/>
   <Column ss:StyleID="s62" ss:Width="69" ss:Span="3"/>
   <Column ss:Index="21" ss:StyleID="s62" ss:Width="80.25"/>
   <Column ss:StyleID="s62" ss:AutoFitWidth="0"/>
   <Column ss:StyleID="s62" ss:Width="58.5"/>
   ...
   <Row>
    <Cell ss:StyleID="s64"><Data ss:Type="String">UW</Data></Cell>
    <Cell ss:StyleID="s64"><Data ss:Type="String">1111111111</Data></Cell>
   </Row>
  </Table>
