 ...
 <Worksheet ss:Name="Sheet1">
  <Table ss:ExpandedColumnCount="22" ss:ExpandedRowCount="900000" x:FullColumns="1"
   ...
   <Row>
    ...
    <Cell><Data ss:Type="String">P0发运周期</Data></Cell>
    ...
    <Cell><Data ss:Type="String">P4基准</Data></Cell>
    <Cell><Data ss:Type="String">P4比较数</Data></Cell>
    <Cell><Data ss:Type="String">P4比例</Data></Cell>
   </Row>
    <#list list as dingdresult>
   <Row>
    ...
    <Cell><Data ss:Type="String">${dingdresult.p0fyzqxh!''}</Data></Cell>
    ...
    <Cell><Data ss:Type="String">${dingdresult.jizhunSlp4!''}</Data></Cell>
    <Cell><Data ss:Type="String">${dingdresult.bijiaoSlp4!''}</Data></Cell>
    <Cell><Data ss:Type="String">${dingdresult.bijiaop4!''}</Data></Cell>
   </Row>  
    </#list>
  </Table>
