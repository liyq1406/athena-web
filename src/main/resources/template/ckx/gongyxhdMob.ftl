...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
 ...
 <Worksheet ss:Name="gongyxhd">
  <Table ss:ExpandedColumnCount="32" ss:ExpandedRowCount="3" x:FullColumns="1"
   x:FullRows="1">
   ...
   <Column ss:StyleID="s22" ss:Width="69"/>
   <Column ss:StyleID="s21" ss:Width="58.5" ss:Span="1"/>
   <Column ss:Index="7" ss:StyleID="s21" ss:Width="51"/>
   <Column ss:StyleID="s21" ss:Width="58.5"/>
   ...
   <Column ss:Index="20" ss:StyleID="s21" ss:Width="80.25"/>
   <Column ss:StyleID="s21" ss:Width="58.5"/>
   <Column ss:StyleID="s21" ss:Width="91.5"/>
   <Column ss:StyleID="s21" ss:Width="69" ss:Span="3"/>
   <Column ss:Index="27" ss:StyleID="s21" ss:Width="80.25"/>
   <Column ss:StyleID="s21" ss:AutoFitWidth="0"/>
   <Column ss:StyleID="s21" ss:Width="58.5"/>
   ...
   <Column ss:StyleID="s21" ss:Width="69"/>
   <Row>
    <Cell><Data ss:Type="String">GONGYXHD</Data></Cell>
    <Cell><Data ss:Type="String">CHESSL</Data></Cell>
   </Row>
   <Row>
    <Cell ss:StyleID="s25"><Data ss:Type="String">工艺消耗点</Data></Cell>
    <Cell ss:StyleID="s25"><Data ss:Type="String">工艺车身数(正整数)</Data></Cell>
   </Row>
   <Row>
    <Cell ss:StyleID="s24"><Data ss:Type="String">W051408KE</Data></Cell>
    <Cell ss:StyleID="s24"><Data ss:Type="String">10</Data></Cell>
   </Row>
  </Table>
