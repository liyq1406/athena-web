...
public class PDALoginUser {
	...
	private List<PDABaseCode> warehouselist;  //仓库List集合
	...
	*/
	...
	public List<PDABaseCode> getWarehouselist() {
		if (warehouselist==null){
			warehouselist = new ArrayList<PDABaseCode>();
		}
		return warehouselist;
	}

	public void setWarehouselist(List<PDABaseCode> warehouselist) {
